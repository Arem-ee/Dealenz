...
export async function proxy(request: NextRequest) {
  ...
  if (!user && (pathname.startsWith("/dashboard") || pathname.startsWith("/audit") || pathname.startsWith("/ask") || pathname.startsWith("/deals") || pathname.startsWith("/vault") || pathname.startsWith("/clients") || pathname.startsWith("/risk-intelligence") || pathname.startsWith("/templates") || pathname.startsWith("/billing") || pathname.startsWith("/lawyer") || pathname.startsWith("/admin")) && !pathname.startsWith("/view")) {
    const url = request.nextUrl.clone()
    url.pathname = "/login"
    await logEventWithClient(supabase, {
      phase: "auth_redirect",
