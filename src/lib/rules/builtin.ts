...
export const BUILTIN_RULES: Rule[] = [
  {
    ...
    finding: {
      ...
      pushback: "Please confirm in writing the amount I will be paid, what it covers, and when each payment is due.",
    },
  ...
  },
  {
    ...
    finding: {
      ...
      pushback: "Please add start dates and milestones, plus what happens if either side is late.",
    },
    authority: { kind: "product_policy", note: PRODUCT_POLICY_NOTE },
  },
  {
    ...
    finding: {
      ...
      pushback: "Please confirm the full legal name of the other party and what they owe under this deal.",
    },
    authority: { kind: "product_policy", note: PRODUCT_POLICY_NOTE },
  },
  {
    ...
    finding: {
      ...
      pushback: "Please state which country's law governs this agreement.",
    },
    authority: { kind: "product_policy", note: PRODUCT_POLICY_NOTE },
  },
  {
  ...
  },
  {
    ...
    finding: {
      ...
      pushback: "Before I sign, please resend the key terms as plain text so we both work from the same version.",
    },
    authority: { kind: "product_policy", note: PRODUCT_POLICY_NOTE },
  },
]
