...
export const FOUNDER_RULES: Rule[] = [
  rule({
    ...
    finding: {
      ...
      pushback: "Please write each founder's ownership percentage into the agreement before we go further.",
    },
  ...
  rule({
    ...
    finding: {
      ...
      pushback: "Please add a vesting schedule with a one-year cliff and clear terms for what happens on exit.",
    },
    authority: { kind: "product_policy", note: POLICY },
  }),
  rule({
    ...
    finding: {
      ...
      pushback: "Please confirm in writing that work created by founders belongs to the company.",
    },
    authority: { kind: "product_policy", note: POLICY },
  }),
  rule({
    ...
    finding: {
      ...
      pushback: "Please state each founder's role and who has the final say on what.",
    },
    authority: { kind: "product_policy", note: POLICY },
  }),
  rule({
    ...
    finding: {
      ...
      pushback: "Please agree in writing how deadlocks get resolved before one happens.",
    },
    authority: { kind: "product_policy", note: POLICY },
  }),
  rule({
    ...
    finding: {
      ...
      pushback: "Please add what happens to a departing founder's shares.",
    },
    authority: { kind: "product_policy", note: POLICY },
  }),
  rule({
    ...
    finding: {
      ...
      pushback: "Please confirm whether selling shares needs the other founders' consent.",
    },
    authority: { kind: "product_policy", note: POLICY },
  }),
  rule({
    ...
    finding: {
      ...
      pushback: "Please cap liability, for example at invested capital.",
    },
    authority: { kind: "product_policy", note: POLICY },
  }),
  rule({
  ...
  rule({
    ...
    finding: {
      ...
      pushback: "The draft lists two different timelines. Please confirm which dates apply and remove the others.",
    },
    authority: { kind: "product_policy", note: POLICY },
  }),
]
