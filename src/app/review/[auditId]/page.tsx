        ...
        <div className="grid gap-6 md:grid-cols-[1fr_300px]">
          <div className="space-y-4">
            <div className="rounded-xl border bg-card p-4">
              ...
              <p className="mt-2 text-xs text-muted-foreground whitespace-pre-wrap">{String((audit as { raw_input?: unknown }).raw_input ?? "").slice(0, 800) || "No deal text yet."}</p>
              {handoff && (
            ...
            <div className="rounded-xl border bg-card p-4">
              ...
              <p className="mt-1 text-xs text-muted-foreground">Notes tied to this review will appear here. For Phase 3, use the thread to continue discussion; this case file is the async record.</p>
